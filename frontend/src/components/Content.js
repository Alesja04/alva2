        ...
        <Router>
          <Routes>
            ...
            <Route
              exact
              path="/tooded/:id"
              element={<Tooded items={this.props.items} onAdd={this.props.onAdd} />}
            />

            <Route exact path="/delivery" element={<Delivery clearCart={this.props.clearCart} />} />
            ...
            <Route exact path="/login" element={<AdminPage />} />
